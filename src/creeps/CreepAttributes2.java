...
//	private int timeUntilDisorient;
	...
	//TODO: Unacceptable
	CreepAttributes2(Creep parent, float[] maxDamageResistsFlat, float[] slowResists, float maxHealth, float healthRegenRate, float maxToughness, float maxShieldValue, float shieldRegenRate, boolean snareImmune, boolean disorientImmune, float maxSpeed, float disruptorAmount) {
		this.parent = parent;
	...
	private CreepAttributes2(CreepAttributes attributes) {
